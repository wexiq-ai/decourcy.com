...
export function RunSweepButton({ inboxUnread }: { inboxUnread: number }) {
  const estHaiku = (inboxUnread * 0.0003).toFixed(2);
  const estSonnet = (inboxUnread * 0.0006 * 0.2).toFixed(2);
